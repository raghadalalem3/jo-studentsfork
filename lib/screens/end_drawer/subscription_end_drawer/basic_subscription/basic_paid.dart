...
class BasicPaidCard extends StatefulWidget {
  List<String> list;
  String subjectName;

  BasicPaidCard({super.key, required this.list, required this.subjectName});

  @override
  State<BasicPaidCard> createState() => _BasicPaidCardState();
}

class _BasicPaidCardState extends State<BasicPaidCard> {
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 3.h),
                            CommonViews().customText(
                              textContent: widget.subjectName,
                              fontSize: 13.sp,
                              fontWeight: FontWeight.bold,
                              textColor:  Theme.of(context).textTheme.bodyLarge!.color,
                            ),
                      ...
                      Container(
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: const Color(0xff6d6b77)),
                        ),
                        padding: const EdgeInsets.symmetric(
                            horizontal: 16.0, vertical: 16.0),
                        margin: const EdgeInsets.all(8),
