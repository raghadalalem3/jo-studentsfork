...
class BasicCardScreen extends StatelessWidget {
  ...
  BasicCardScreen({super.key, required this.subjectName});
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CommonViews().customClickableContainer(
                              ...
                              radius: 8,
                              onTap: () {
                                AppNavigator.of(context).push(BasicPaidCard(
                                  list: _second,
                              ...
                              child: Center(
                                child: CommonViews().customText(
                                    ...
                                    fontSize: 13.sp,
                                    fontWeight: FontWeight.w700,
                                    textColor: const Color(0xff28c76f)),
                              ),
                            ),
                            SizedBox(height: 1.h),
                          ],
