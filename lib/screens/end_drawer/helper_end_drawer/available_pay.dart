...
class AvailablePay extends StatelessWidget {
  final String title;
  final controller = Get.find<MainSectionsController>();

  AvailablePay({super.key, required this.title});
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Obx(() {
                            return Column(
                              children: controller.filterPaymentMethod2.map((item) {
                                return GestureDetector(
                                  onTap: () {
                                    controller.selectedPaymentMethod.value = item;
                                    controller.updateFilteredPaymentMethods();
                                    AppNavigator.of(context).pushReplacement(
                                      AvailablePay(title: item),
                                    );
                                  },
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        CommonViews().customText(
                                          textContent: item,
                                          fontSize: 13.sp,
                                          textColor: controller.selectedPaymentMethod.value == item
                                              ? const Color(0xff7367f0) // Selected color
                                              : const Color(0xff595664), // Default color
                                        ),
                                        const Icon(
