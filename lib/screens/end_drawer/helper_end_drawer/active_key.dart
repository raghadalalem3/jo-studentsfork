...
class ActiveKey extends StatelessWidget {
  final String title;
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Obx(() {
                            return Column(
                              children:controller.filterActiveKey2.map((item) {
                                return GestureDetector(
                                  onTap: () {
                                    controller.selectedActiveKey.value = item;
                                    controller.updateFilteredActiveKey();
                                    AppNavigator.of(context).pushReplacement(ActiveKey(
                                      title: item,
                                    ));
                                  },
                                  child: Padding(
